...
public class GroupedTodoItemRenderer extends DefaultGroupedListItemRenderer
	{
		private static var COUNT:int;

		private var count = COUNT;

		public function GroupedTodoItemRenderer()
		{
			super();
...
//			this.height = 600;
		...
		{
			GroupedList(this._owner).dataProvider.removeItemAt(this._itemIndex, _groupIndex);
		}
	}
}
